...
export const STATE_MISS_FUNC = 1;
export const STATE_ARGS_DECODE_ERROR = 2;
export const STATE_BATCH_LIMIT = 3;
export const STATE_CALL_ERROR = 4;
export const STATE_NO_PERMISSION = 5;
export const STATE_NEED_SIGNIN = 6;
export const STATE_CAPTCHA = 7;
export const STATE_JSON = 8;
export const STATE_CODE = 9;
